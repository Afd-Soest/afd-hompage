...
const DataProtection = () => {
  return (
    <section id="data" className="firstSector">
      <div>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            E-Mail: <a href="mailto:info@afd-soest.de">vorstand@afd-soest.de</a>
          </li>
        </ul>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          ...
          selbst für den Kommentar oder Beitrag belangt werden und sind daher an
          der Identität des Verfassers interessiert.
        </p>
        <p>
        ...
        <p>
          Die im Rahmen der Kommentare und Beiträge mitgeteilte Informationen
          zur Person, etwaige Kontakt- sowie Websiteinformationen als auch die
      ...
      <div>
        ...
        <p>
          ...
          wird. Die Nutzung erfolgt auf Grundlage unserer berechtigten
          Interessen im Sinne des Art. 6 Abs. 1 lit. f) DSGVO. Mit Hilfe dieses
          Dienstes werden Kommentare echter Menschen von Spam-Kommentaren
          ...
          IP-Adresse, der Kommentarinhalt, der Referrer, Angaben zum verwendeten
          Browser sowie dem Computersystem und die Zeit des Eintrags.
        </p>
      ...
      <div>
        ...
        <p>
          ...
          unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) das
          Plugin Jetpack (hier die Unterfunktion „Wordpress Stats“), welches ein
          Tool zur statistischen Auswertung der Besucherzugriffe einbindet und
          von Automattic Inc., 60 29th Street #343, San Francisco, CA 94110,
          USA. Jetpack verwendet sog. „Cookies“, Textdateien, die auf Ihrem
        ...
        <p>
          ...
          <a href="https://jetpack.com/support/cookies/" target="_blank">
      ...
      <div>
        <h2>Facebook-Pixel, Custom Audiences und Facebook-Conversion</h2>
        ...
        <p>
          ...
          Facebook Inc., 1 Hacker Way, Menlo Park, CA 94025, USA, bzw. falls Sie
          in der EU ansässig sind, Facebook Ireland Ltd., 4 Grand Canal Square,
      ...
      <div>
        ...
        <p>
          ...
          <a href="http://instagram.com/about/legal/privacy/" target="_blank">
        ...
        <p>
          Datenschutzerklärung/ Opt-Out:{" "}
          <a href="https://wakelet.com/privacy.html" target="_blank">
      ...
      <div>
        ...
        <p>
          ...
          Canal Harbour, Dublin 2, Irland betrieben wird („Facebook“). Hierzu
      ...
      <div>
        ...
        <p>
          ...
          innerhalb von Twitter teilen können. Sofern die Nutzer Mitglieder der
          Plattform Twitter sind, kann Twitter den Aufruf der o.g. Inhalte und
          Funktionen den dortigen Profilen der Nutzer zuordnen. Twitter ist
      ...
      <div>
        ...
        <p>
          ...
          Instagram teilen können. Sofern die Nutzer Mitglieder der Plattform
